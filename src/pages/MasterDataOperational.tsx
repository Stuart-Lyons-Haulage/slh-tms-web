    ...
    try {
      ...
      if (tab === 'sites') {
        ...
        if (includeInactive) {
          ...
          } catch { /* keep complete active register even if archived lookup is unavailable */ }
        }
