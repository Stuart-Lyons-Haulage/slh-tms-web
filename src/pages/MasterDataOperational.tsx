...
const config: Record<MasterDataTab, { title: string; search: string; entityType: string; columns: Array<[string, string]>; editable: Array<[string, string, EditType]> }> = {
  ...
  sites: { title: 'Sites', search: 'Site name, code, postcode, region or driver text name', entityType: 'Site', columns: [['name','Site'],['externalCode','Code'],['driverTextName','Driver text'],['collectionAddress','Address / postcode'],['defaultTemperatureC','Default temp'],['region','Planning region']], editable: [['externalCode','External code','text'],['name','Site name','text'],['driverTextName','Driver text name','text'],['collectionAddress','Address / postcode','textarea'],['collectionInstructions','Collection instructions / notes','textarea'],['mapLink','Map link','text'],['defaultTemperatureC','Default temperature °C','number'],['region','Planning region','region']] },
