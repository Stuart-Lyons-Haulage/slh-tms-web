...
import { Admin, CustomersMaster, Dashboard, DriverAssignments, DriverMobile, ExportCentre, FuelMaster, LiveTracking, MasterData, Reporting, SitesMaster } from './pages/Pages';
...
import { MarketsMasterClean } from './pages/MarketsMasterClean';
import { OperationsControlClean } from './pages/OperationsControlClean';
...
const insightNavigation = [
  ['/attention', 'Needs attention'], ['/management', 'Management'], ['/plan-stability', 'Plan stability'], ['/operations-control', 'Ops control'], ['/reporting', 'Reporting'], ['/exports', 'Exports'], ['/admin', 'Admin'],
];
