...
import { Admin, CustomersMaster, Dashboard, DriverAssignments, DriverMobile, Exceptions, ExportCentre, FleetAssetsMaster, FuelMaster, LiveTracking, Loads, MarketsMaster, MasterData, OperationsControl, Orders, PlanningBoard, Reporting, SitesMaster, StagingQueue } from './pages/Pages';
import { DriversOperational } from './pages/DriversOperational';
...
const masterNavigation = [
  ['/customers', 'Customers'],
  ['/drivers', 'Drivers'],
  ['/fleet-assets', 'Vehicles + fuel / trailers'],
  ['/markets', 'Markets'],
  ['/fuel', 'Fuel'],
