...
import { DriverAssignments, DriverMobile } from './pages/Pages';
...
const dailyNavigation = [
  ['/dashboard', 'Dashboard'], ['/operations-wallboard', 'Operations wallboard'], ['/staging', 'Load Review'], ['/', 'Planner'], ['/pallet-control', 'Pallet Control'], ['/driver-dispatch', 'Driver Dispatch'],
];
