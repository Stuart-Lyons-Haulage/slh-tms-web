...
const topNavigation: NavGroup[] = [
  { label: 'Planning', items: [['/staging', 'Load Review'], ['/', 'Planner'], ['/pallet-control', 'Pallet Order'], ['/driver-dispatch', 'Driver Dispatch'], ['/warehouse', 'Warehouse Loads'], ['/communications', 'Customer Communication'], ['/operations-wallboard', 'Live Operations'], ['/exports', 'Exports']] },
