...
import { Admin, CustomersMaster, Dashboard, DriverAssignments, DriverMobile, Exceptions, ExportCentre, FuelMaster, LiveTracking, MarketsMaster, MasterData, OperationsControl, Reporting, SitesMaster } from './pages/Pages';
...
function Shell() {
  ...
  return <div className={`app-shell ${authenticated ? 'with-system-strip' : ''}`}>
    ...
    <main>{authenticated ? <RouteErrorBoundary key={location.pathname}><Routes>
