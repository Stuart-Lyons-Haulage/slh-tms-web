...
export type MasterApplyResponse = { received: number; applied: number; failed: number; results: Array<{ entityType: string; idempotencyKey?: string; applied: boolean; registered?: boolean; error?: string }> };
