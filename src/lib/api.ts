...
export type MasterApplyResponse = { received: number; applied: number; failed: number; results: Array<{ entityType: string; idempotencyKey?: string; applied: boolean; error?: string }> };
...
export type FleetioSync = { sourceVehicleCount: number; tmsVehicleCount: number; updated: number; missingInFleetio: number; syncedAtUtc: string; connected?: boolean; message?: string };
